  ...
  bar: {
    ...
    html: `
      ...
      <div class="category"><div class="category-title">TEQUILA <span style="font-size:14px; opacity:0.7;">Single · Bottle</span></div>
        ${[['Olmeca Silver','8K','250K'],['Olmeca Gold','8K','250K'],['Olmeca Chocolate','8K','220K'],['Jose Cuervo','8K','220K'],['Don Julio Anajo','','550K'],['Don Julio Blanco','','550K'],['Azul','','2.2M']].map(([n,s,b])=>`<div class="menu-item"><div class="item-info"><div class="item-name">${n}</div></div><div class="price-double"><div class="price-row"><span>${s}</span><span>${b}</span></div></div></div>`).join('')}
      </div>
      ...
      <div class="category"><div class="category-title">BLENDED WHISKEY <span style="font-size:14px; opacity:0.7;">Single · Bottle</span></div>
        ${[['Chivas 12yrs','10K','320K'],['Chivas 18yrs','','600K'],['Jameson Irish','8K','220K'],['Jameson Black Barrel','','300K'],['JW Red Label','8K','160K'],['JW Black Label','9K','280K'],['JW Double Black','11K','350K'],['JW Gold Reserve','20K','450K'],['JW 18yrs','','800K'],['JW Blue Label','','1.5M'],['Black & White','6K','120K'],['Jack Daniels No 7','9K','280K'],['Jack Daniels Fire','9K','280K'],['Jim Beam','8K','220K']].map(([n,s,b])=>`<div class="menu-item"><div class="item-info"><div class="item-name">${n}</div></div><div class="price-double"><div class="price-row"><span>${s}</span><span>${b}</span></div></div></div>`).join('')}
      </div>
